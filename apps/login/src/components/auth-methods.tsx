  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      ...
      >
        ...
        <span className="text-primary">Authenticator App</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      ...
      >
        ...
        <span className="text-primary">Universal Second Factor</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      ...
      >
        ...
        <span className="text-primary">Code via Email</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
  ...
  return (
    <LinkWrapper key={link} alreadyAdded={alreadyAdded} link={link}>
      ...
      >
        ...
        <span className="text-primary">Code via SMS</span>
      </div>
      {alreadyAdded && (
        <>
          <Setup />
